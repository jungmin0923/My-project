...
public class EnemyController : MonoBehaviour
{
    ...
    public float ratationSpeed = 1.0f;          //적의 포탑 회전 속도
    ...
    { 
       ...
       if(Vector3.Distance(player.position , transform.position) > 1.0f)                //Vector3.Distance <== 거리를 알려주는 함수
        ...
        enemyPiovt.transform.rotation = Quaternion.Lerp(enemyPiovt.transform.rotation, targetRotation, ratationSpeed * Time.deltaTime);
